class TvsController < ApplicationController
  ...
  private
    ...
    def tv_params
      params.require(:tv).permit(:name, :price, :code, :brand, :tvmodel, :screensize, :maxres, :aspectratio, :displaycolor, :brightness, :contrastratio, :response, :refreshrate, :video, :tuner, :audio, :hdmi, :usb, :digiatlaudio, :componentvideo, :otherconnectors, :power, :mount, :features, :dimension, :weight, :other, :warranty)
    end
end
