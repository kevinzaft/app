class AmplifiersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @amplifier.save
        ...
        format.json { render :show, status: :created, location: @amplifier }
      else
  ...
  def update
    respond_to do |format|
      if @amplifier.update(amplifier_params)
        ...
        format.json { render :show, status: :ok, location: @amplifier }
      else
  ...
  def destroy
    @amplifier.destroy
    respond_to do |format|
      format.html { redirect_to amplifiers_url, notice: 'Amplifier was successfully destroyed.' }
  ...
  private
    ...
    def amplifier_params
      params.require(:amplifier).permit(:name, :price, :code, :brand, :brandmodel, :specification, :features, :dimensions, :weight, :other, :warranty)
    end
end
