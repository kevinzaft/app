class SpeakersController < ApplicationController
  ...
  private
    ...
    def speaker_params
      params.require(:speaker).permit(:name, :price, :code, :brand, :brandmodel, :speakertype, :speakerconfig, :power, :frequency, :systemrequirements, :dimensions, :weight, :features, :packagecontents, :plug, :warranty, :other)
    end
end
