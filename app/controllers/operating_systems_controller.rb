class OperatingSystemsController < ApplicationController
  ...
  private
    ...
    def operating_system_params
      params.require(:operating_system).permit(:name, :price, :code, :disclaimer, :brand, :brandmodel, :bitversion, :version, :systemrequirements, :packaging, :features, :warranty, :other)
    end
end
