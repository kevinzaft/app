class CamerasController < ApplicationController
  ...
  private
    ...
    def camera_params
      params.require(:camera).permit(:name, :price, :code, :cameramodel, :details, :imagesensor, :whitebalance, :viewfinder, :lcdmonitor, :focus, :exposure, :shutter, :flash, :drive, :function, :recording, :movie, :lens, :other, :warranty)
    end
end
